...
// تدريب عملي وفهم الdom


// فهم أهم ثلاث مواضيع :
// يجب فهم أنواع البيانات في جافا سكريبت 
// يجب مراجعة فهم وتركيبة DOM 
// بدك تفهم الدوال في جافا سكريبت
...
document.getElementById("org").style.border = "1px solid";
